...
export default function NotFoundPage() {
 return (
 <div className="bg-gray-50 p-6 flex items-center justify-center min-h-screen">
 ...
 <Link
 href="/"
 className="px-6 py-3 text-lg font-semibold text-white bg-gray-50 rounded-lg shadow-lg hover:from-purple-600 hover:to-blue-600 transition-all duration-300 transform hover:scale-105"
 >
 Go Back Home
 </Link>
 </div>
