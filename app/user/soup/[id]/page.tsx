...
import { getSoupRecipeById } from '@/app/actions/soupactions';
  ...
  useEffect(() => {
    const fetchSoupRecipe = async () => {
      try {
        ...
        const data = await getSoupRecipeById(Number(recipeId));
        setRecipe(data);
      } catch (error) {
