...
import SoupPage from '../page'; // Import the client component
...
interface SoupPageWrapperProps {
  params: { id: string }; // id is always a string from the URL parameters
}

const SoupPageWrapper = async ({ params }: SoupPageWrapperProps) => {
  ...
  return <SoupPage recipeId={params.id} user={user} />;
};

export default SoupPageWrapper;
