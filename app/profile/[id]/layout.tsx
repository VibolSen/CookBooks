...
const UserLayout = ({ children }: UserLayoutProps) => {
 ...
 <div className="inline-flex items-center px-3 py-1.5 bg-gray-50 rounded-full border border-violet-200 mb-3">
 ...
 <h2 className="text-lg font-bold text-brand-black">Welcome back!</h2>
