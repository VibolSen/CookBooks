...
export default function ProfilePage() {
  ...
  return (
    <motion.div
      className="min-h-screen bg-gradient-to-br from-violet-50 via-pink-50 to-indigo-50 dark:from-gray-900 py-12 px-6"
    ...
    >
      <div className="max-w-4xl mx-auto">
        <motion.div className="text-center mb-10" variants={itemVariants}>
          <h1 className="text-4xl font-bold bg-gradient-to-r from-violet-600 to-indigo-600 bg-clip-text text-transparent">Welcome, {user.userName}!</h1>
        </motion.div>

        <motion.div className="bg-white dark:bg-gray-800 rounded-3xl shadow-xl overflow-hidden" variants={itemVariants}>
          <div className="bg-gradient-to-r from-violet-500 to-indigo-500 p-8 flex items-center gap-6">
            <Image
