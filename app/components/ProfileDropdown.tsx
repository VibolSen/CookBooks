...
const ProfileDropdown: React.FC<ProfileDropdownProps> = ({
 ...
 <div className="w-10 h-10 rounded-full bg-gray-50 flex items-center justify-center ring-2 ring-purple-200 dark:ring-purple-700 shadow-lg">
 ...
 >
 {/* User Info Header */}
 <div className="px-4 py-3 border-b border-gray-100 dark:border-gray-700 bg-gray-50 ">
 ...
 <div className="w-8 h-8 rounded-full bg-gray-50 flex items-center justify-center shadow-md">
