...
const InteractiveRating = ({
  ...
  if (!session?.user) {
    return (
      <div className="bg-gradient-to-r from-orange-50 to-pink-50 dark:from-gray-800/50 dark:to-gray-700/50 rounded-3xl p-8 text-center border-2 border-dashed border-orange-200 dark:border-gray-700">
        ...
        <button className="px-8 py-3 bg-gradient-to-r from-orange-500 to-pink-500 text-white rounded-xl font-bold shadow-lg hover:scale-105 transition-all">
          Sign In to Rate
        </button>
      </div>
    );
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-xl border border-gray-100 dark:border-gray-700 p-8">
      ...
      <button
        ...
        className="w-full py-4 bg-gradient-to-r from-orange-500 to-pink-500 text-white rounded-2xl font-bold shadow-lg hover:shadow-xl transition-all disabled:opacity-50 flex items-center justify-center gap-3"
      >
