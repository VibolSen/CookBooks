...
export default function Component({ recipe }: RecipeGalleryProps) {
 ...
 <>
 <motion.section
 className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-orange-50 via-white to-amber-50 p-8 mb-8 border border-orange-200/30 dark:border-gray-700/30"
