...
export default function ProfileAdminPage() {
 ...
 return (
 <motion.div
 className="min-h-screen bg-gray-50 py-8 px-4 sm:px-6 flex justify-center"
 ...
 <CardHeader className="bg-brand-primary text-brand-white p-6 pb-16 relative">
 ...
 <motion.div
 className="w-24 h-24 rounded-full bg-gray-50 flex items-center justify-center border-4 border-white dark:border-gray-800 shadow-lg"
 whileHover={{ scale: 1.05 }}
 transition={{ type: "spring", stiffness: 300 }}
 >
 ...
 <motion.div
 className="bg-gray-50 p-3 rounded-lg border border-emerald-100 dark:border-emerald-800 text-sm"
 ...
 <motion.div
 className="bg-gray-50 p-3 rounded-lg border border-blue-100 dark:border-blue-800 text-sm"
 whileHover={{ scale: 1.02 }}
 transition={{ type: "spring", stiffness: 300 }}
 >
 <div className="flex items-center">
 ...
 <div className="bg-gray-50 p-5 rounded-xl border border-violet-100 dark:border-violet-800/50">
 ...
 <Link size={18} className="text-pink-500" />
 </div>
 <div>
 <h4 className="font-medium text-gray-800 dark:text-white">
 Website
